...
public interface Inventory extends EObject {
	/**
	 * Returns the value of the '<em><b>Yeast</b></em>' containment reference
	 * list. The list contents are of type {@link brewery.Yeast}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Yeast</em>' containment reference list isn't
