...
public class BreweryPackageImpl extends EPackageImpl implements BreweryPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getYeast_Manufacturer(), ecorePackage.getEString(),
				...
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getYeast_Range(), this.getTemperatureRange(), null,
				"range", null, 1, 1, Yeast.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(inventoryEClass, Inventory.class, "Inventory", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInventory_Yeast(), this.getYeast(), null, "yeast",
				null, 0, -1, Inventory.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTemperatureRange_Unit(), this.getTemperatureUnit(),
		...
		initEAttribute(getFermenter_Name(), ecorePackage.getEString(), "name",
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getFermenter_Yeast(), this.getYeast(), null, "yeast",
				null, 1, 1, Fermenter.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
